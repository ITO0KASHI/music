<template>
  ...
  <!-- 删除提示框 -->
  <music-del-dialog :delVisible="delVisible" @confirm="confirm" @cancelRow="delVisible = $event"></music-del-dialog>
</template>
...
import MusicDelDialog from "@/components/dialog/MusicDelDialog.vue";
