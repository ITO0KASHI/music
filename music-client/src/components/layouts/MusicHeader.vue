<template>
  <div class="music-header">
    ...
    <div class="header-logo" @click="goPage()">
      <music-icon :icon="iconList.ERJI"></music-icon>
      <span>{{ musicName }}</span>
    </div>
    <music-header-nav class="music-header-nav" :styleList="headerNavList" :activeName="activeNavName" @click="goPage"></music-header-nav>
    <!--搜索框-->
    <div class="header-search">
      <el-input placeholder="搜索" :prefix-icon="Search" v-model="keywords" @keyup.enter="goSearch()" />
    </div>
    <!--设置-->
    <music-header-nav v-if="!token" :styleList="signList" :activeName="activeNavName" @click="goPage"></music-header-nav>
...
import MusicHeaderNav from "./MusicHeaderNav.vue";
